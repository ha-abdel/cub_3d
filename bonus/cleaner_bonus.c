...
/*   Updated: 2025/07/23 10:58:22 by abdel-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	clean_mlx_mandatory_resources(t_data **data)
{
	...
	if ((*data)->sprite_door.img)
		mlx_destroy_image((*data)->mlx, (*data)->sprite_door.img);
	if ((*data)->minimap.img)
		mlx_destroy_image((*data)->mlx, (*data)->minimap.img);
	if ((*data)->frame_door.img)
		mlx_destroy_image((*data)->mlx, (*data)->frame_door.img);
	if ((*data)->bg.img)
